...
class GeminiSummarizer(OpenRouterSummarizer):
    ...
    def _request_streaming(
        ...
        *,
        ...
        # Controlled Synapse ingestion does not require token streaming. Falling
        # back to one GenerateContent call keeps the provider adapter small and
        # preserves the exact same validation/audit path as non-streaming runs.
