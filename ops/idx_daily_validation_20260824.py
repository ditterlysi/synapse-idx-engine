...
START = "2026-08-22T03:19:36.890123+07:00"
END = "2026-08-24T03:19:36.890123+07:00"
...
def main() -> None:
    ...
    checkpoint_path = Path("idx-daily-validation-checkpoint.json")
    ...
    try:
        ...
        report = {
            ...
            "checkpointCommittedLocal": result.processing_ok,
            "durableCheckpointWritten": False,
        }
        Path("ops/idx-daily-validation-result.json").write_text(
